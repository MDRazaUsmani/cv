[Artstation](https://www.artstation.com/razausmani) / [Linkedin](https://www.linkedin.com/in/mdrazausmani/) / [Behance](https://www.behance.net/razausmani) / [Portfolio](assets/Portfolio-2025.pdf)
...
**Web Development:** HTML, CSS, PHP, JavaScript, MySQL, REST\
...
- _Leading and collaborating with Agile subteams to develop high-priority modules:_ Enhancing the “Abschlussarbeit / Thesis” module as the team’s primary
developer for new features
- Adopting Kanban task management, MVC design architecture
- _Creating and maintaining Wiki pages for TUM School of Management:_ Documenting old and newly developed features for end-users in the project Wiki and
